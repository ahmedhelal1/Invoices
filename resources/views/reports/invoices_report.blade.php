        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ route('Search_invoices') }}" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="radio" type="radio" onclick="searchByType(this.value)"
                                value="1" id="type_div"> <span>بحث بنوع
                                الفاتورة</span></label>
                    </div>


                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox"><input name="radio" onclick="searchByType(this.value)" value="2"
                                type="radio"><span>بحث برقم
                                الفاتورة
                            </span></label>
                    </div><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">تحديد نوع الفواتير</p><select class="form-control select2" name="type"
                                ...
                                <option value="all invoices">كل الفواتير</option>
...
<script>
    ...
    window.onload = function() {
        invoice_number.style.display = 'none';
    }

    function searchByType(radio) {
        if (radio == 1) {
            invoice_number.style.display = 'none';
            ...
            invoice_number.style.display = 'block';
