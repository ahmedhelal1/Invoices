                    ...
                    <form action="{{ route('invoices.update', $invoices->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="{{ $invoices->invoices_number }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" value="{{ $invoices->amount_collection }}" class="form-control"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" value="{{ $invoices->discount }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" value="{{ $invoices->total }}" class="form-control"
